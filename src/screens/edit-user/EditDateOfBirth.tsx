...
const EditDateOfBirthScreen = ({ navigation }: any) => {
  ...
  const handleSave = async () => {
    ...
    try {
      setLoading(true);
      const res = await axiosClient.put("/user/0", { new_date_of_birth: dateOfBirth });
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.label}>Chỉnh sửa ngày sinh</Text>
      <TextInput
